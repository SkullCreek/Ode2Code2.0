...
<>
    <div className="app-header">
        <div className="app-header-left">
            <img src="images/logo/logo.svg" alt="logo" width="30" style={{marginRight:"3rem"}}/>
        ...
        <div className="app-header-right">
            ...
            <button className="add-btn feather feather-plus" title="Add New Project">
                <svg className="btn-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
